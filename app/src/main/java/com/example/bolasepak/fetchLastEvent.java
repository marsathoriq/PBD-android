...
public class fetchLastEvent extends AsyncTask<String, Void, String> {
    ...
    public fetchLastEvent(TextView mEvent, TextView eventName, TextView homeId, TextView homeName, TextView awayId, TextView awayName, TextView homeScore, TextView awayScore, TextView mDate, ImageView mHomeImage, ImageView mAwayImage) {
        this.mEvent = mEvent;
