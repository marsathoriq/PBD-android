...
public class FetchEventFuture extends AsyncTask<String, Void, String> {

    @Override
    protected String doInBackground(String... strings) {
        return com.example.bolasepak.NetworkUtilsParam.getData(strings[0],"https://www.thesportsdb.com/api/v1/json/1/eventsnextleague.php?","id");
    }
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            for (int i = 0; i < eventsArray.length(); i++){
                ...
                // new FetchImageTeam().execute(homeId);
                // new FetchImageTeam().execute(awayId);
