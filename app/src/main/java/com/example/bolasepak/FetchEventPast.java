...
public class FetchEventPast extends AsyncTask<String, Void, String> {

    @Override
    protected String doInBackground(String... strings) {
        return com.example.bolasepak.NetworkUtilsParam.getData(strings[0],"https://www.thesportsdb.com/api/v1/json/1/eventspastleague.php?","id");
    }
